...
if($mysqli === false){
    ...
    die("ERROR: Could not connect. " . $mysqli->connect_error);
		...
		$sql = "SELECT `id_cancha`, `id_gym`, `Nombre`, `Precio` FROM `canchas` WHERE `id_cancha`= 42";
...
<body>
    ...
    <div class="address-bar">Aqui sera una estrella deportiva</div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">2° cancha de basquetbol</h1>
