...
if($mysqli === false){
    ...
    $sql = "SELECT `id_gym`, `Nombre`, `Descripcion`, `Imagen` FROM `gym` WHERE `id_gym` =2";
...
<body>
    ...
    <div class="brand">El Phelps</div>
    <div class="address-bar">Donde se construyen los campeones</div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="elphelps_index.php">principal</a>
                    </li>  
                    <li>
                        <a href="piscina1.php">Picina Olimpica 1</a>
                    </li>                  
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">Bienvenidos a nuestro lugar especial</h1>
